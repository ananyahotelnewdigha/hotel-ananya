        ...
        <div className="bg-[#F8F9FA] min-h-screen pb-24 md:pb-0 relative select-none">
            ...
            <section className="py-8 pl-4 lg:pl-10">
                ...
                <div className="flex overflow-x-auto gap-4 pr-4 no-scrollbar">
                    ...
                    {dineItems.length === 0 && !loadingDine && (
                        <div className="w-full text-center py-10 pr-4">
                            <p className="text-[10px] font-bold text-slate-300 uppercase tracking-widest italic">Inventory updating...</p>
                        </div>
                    )}
                </div>
            </section>
